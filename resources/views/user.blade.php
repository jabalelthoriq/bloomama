    ...
    <div class="main-content">
        <div class="header-container">
         ...
         <div class="row mb-5">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-4 fw-bold">Input Bidan</h5>
                        <form>
                            <div class="mb-3">
                                <label for="name" class="form-label">Nama Bidan</label>
                                <input type="text" class="form-control" id="name" placeholder="Masukkan nama bidan">
                            </div>
                            <div class="mb-3">
                                <label for="email" class="form-label">Email</label>
                                <input type="text" class="form-control" id="email" placeholder="Masukkan email bidan">
                            </div>
                            <div class="mb-3">
                                <input type="checkbox" class="form-check-input" id="statusCheck" checked>
                                <label for="status" class="form-label">Status  </label>
                                <div style="padding-left: 20px" class="status-text">Aktif</div>
                            </div>
        ...
        <div class="row mb-5">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-4 fw-bold">Tabel Data Bidan</h5>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-4 fw-bold">Tabel Data Pasien</h5>
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                <thead>
                                    <tr>
